...
import com.IssuerBanks.IssuerBanks.Repositories.CardRepositories.CardRepository_American_Express;
...
@Service
public class AmericanExpressCardService implements CardFactory {

    @Autowired
    private CardRepository_American_Express cardRepo;
    ...
    public boolean authenticateTransaction(String id,String cardNumber,
        ...
        AmericanExpressCards card = cardRepo.findByCardNumber(cardNumber);
    ...
    public Iterable<AmericanExpressCards> getAllCards(){
    ...
    public Iterable<AmericanExpressCards> getAllLockedCards(){
    ...
    public AmericanExpressCards getByAccount(String accountNumber){
    ...
    public AmericanExpressCards getByCardNumber(String cardNumber){
    ...
    public List<AmericanExpressCards> getByAssociation(int association){
    ...
    public List<AmericanExpressCards> getAllFlagged( ){
    ...
    public List<AmericanExpressCards> getAllLocked( ){
    ...
    public List<AmericanExpressCards> getByExpDate(String expDate){
