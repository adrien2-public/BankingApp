...
@Entity
@Table(name="CapitalOneCards")
public class CapitalOneCards {
    @Id
    ...
    public CapitalOneCards( String customerAccount,String cardNumber,String exp, int pin, int ccv, boolean locked, boolean flagged,float balance,
