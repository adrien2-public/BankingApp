...
@Entity
@Table(name="DiscoverCards")
public class DiscoverCards {
    @Id
    ...
    public DiscoverCards( String customerAccount,String cardNumber,String exp, int pin, int ccv, boolean locked, boolean flagged,float balance,
