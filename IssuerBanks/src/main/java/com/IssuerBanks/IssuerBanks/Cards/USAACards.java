...
@Entity
@Table(name="USAACards")
public class USAACards {
    ...
    public USAACards( String customerAccount,String cardNumber,String exp, int pin, int ccv, boolean locked, boolean flagged,float balance,
