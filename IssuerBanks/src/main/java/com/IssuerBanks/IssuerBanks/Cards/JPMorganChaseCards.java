...
@Entity
@Table(name="JPMorganChaseCards")
public class JPMorganChaseCards {
    ...
    public JPMorganChaseCards(){}
    public JPMorganChaseCards( String customerAccount,String cardNumber,String exp, int pin, int ccv, boolean locked, boolean flagged,float balance,
