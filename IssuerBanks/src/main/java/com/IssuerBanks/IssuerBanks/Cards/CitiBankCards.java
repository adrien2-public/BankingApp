...
@Entity
@Table(name="CitiBankCards")
public class CitiBankCards {
    ...
    public CitiBankCards( String customerAccount,String cardNumber,String exp, int pin, int ccv, boolean locked, boolean flagged,float balance,
