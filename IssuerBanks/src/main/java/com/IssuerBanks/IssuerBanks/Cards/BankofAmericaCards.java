...
@Entity
@Table(name="BankofAmericaCards")
public class BankofAmericaCards {
    ...
    public BankofAmericaCards( String customerAccount,String cardNumber,String exp, int pin, int ccv, boolean locked, boolean flagged,float balance,
