...
@Entity
@Table(name="WellsFargoCards")
public class WellsFargoCards {
    ...
    public WellsFargoCards( String customerAccount,String cardNumber,String exp, int pin, int ccv, boolean locked, boolean flagged,float balance,
